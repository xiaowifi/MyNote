...
* 细分市场差别定价
  ...
  > 差别定价是指同一产品对不同的顾客或不同的细分市场才去不同的价格。差别定价需要满足两个条件，产品有两个或两个以上的市场，不同的市场的价格弹性不同，采用不同的价格取得最大的利润。

* 低价策略

  > 指企业为了提高短期销量，扩大市场占有率，打击竞争对手等销售目标而采用的定价策略。

#### 5.7.2 按价格牵引成本法设计新产品成本 

设计成本的概念，设计成本是指有产品设计方案界定的产品或部件的料本。设计成本观念源于价值工程，认为成本可以预先设计出来，器核心的目标是成本控制，即把目标成本作为与新能指标同等重要的设计产品，在新产品开发任务书中明确，在设计过程中通过不断跟踪和降低成本，使得最终产品的成本低于目标成本。

在新产品开发过程中实现目标设计成本。只有在产品的概念、计划阶段开展成本预测，为原发人员降低成本提供方向指导，并制定出相关的目标成本，才能做好成本控制。设计成本管理的基本思路就是在新产品开发全流程实施目标成本控制，基本步骤如下；

* 在概念计划决策阶段根据市场目标价格、目标毛利率、竞争对手分析资料等完成产品目标设计成本的制定工作，为新产品开发提供目标成本牵引。
* 讲成本纳入产品方案平时要素，对该方案下的集中可能的配置成本进行测算评估，对目标成本进行细化和分解，并约束指标下达给相关设计责任人，有成本工程师对其进行过程监控。
* 整机设计定型鉴定是对几种可能配置下的实际成本进行测算，出具整机目标完成率、器件替换率、复用率指标。

一个产品充概念形成到成熟定型是一个不断否定、逐渐演进的过程，不可避免的存在产品的版本换代升级。充分利用产品设计优化的机会是降低产品设计成本最经济的做法。经验表明，若为降低成本而专门进行的设计优化从综合成本和质量风险的视角区分析是不经济的做法。

影响新产品设计成本的因素主要有两个：产品的设计方案和物料规格选型。加强设计方法的经济性评审，按功能减去成本最佳匹配原则优化设计方案。自爱产品设计方案实施过程中加强器件的选型控制，具体控制好新器件的日黛绿，器件的复用率等综合成本驱动指标，以满足概念、计划阶段要求的目标设计成本。
...
任何事情都有他的两面性，矩阵组织在增强企业产品或项目推广能力，市场渗透能力的同事，也存在弊端，在矩阵组织中，不止一个老板，上上下下需要的更多的沟通协调。每个员工都由不同的老板评估业绩，不再是一个人说了酸，评估结果也更全面，每个人都会更用心的工作，而不是花心思讨好老板，同时运用不同的标准划分企业部门就会形成矩阵式组织。
